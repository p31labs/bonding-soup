...
- **Poets room (lobby):** **`poets-room.html`** — one page linking passport, doc library, mesh-start, geodesic, delta, and normative docs. Same server: **http://127.0.0.1:8080/poets-room.html**. Searchable overview: **`docs/POETS-ROOM.md`**. Hub product card (p31ca) is **`docs/P31-HUB-CARD-ECOSYSTEM.md`** § Poets room when **`andromeda/`** is present.
