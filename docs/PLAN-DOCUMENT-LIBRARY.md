...
**Status:** MVP **shipped** (static search UI + `build:doc-index` / `verify:doc-index` on root `verify`). Optional p31ca `public/doc-library/` deploy remains Phase 3. **Audience:** operators and agents. **Version:** 0.2.0
