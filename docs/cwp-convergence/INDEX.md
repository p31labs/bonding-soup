...
**Production baseline (frozen numbers + gate receipts):** `docs/PRODUCTION-STATE-2026-04-28.md` — paired annotated tags `production-2026-04-28` on bonding-soup and andromeda.
