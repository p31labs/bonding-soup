...
function testTokenValues() {
  ...
  const BANNED_TOKENS = [
    ...
    { wrong: '#25897d', canonical: '#5DCAA5', name: '--p31-teal', source: 'Gemini QMU spec' },
    { wrong: '#3ba372', canonical: '#5dca5d', name: '--p31-phosphorus', source: 'Gemini QMU spec' },
    { wrong: '#d8d6d0', canonical: '#e8e6e3', name: '--p31-cloud', source: 'Gemini QMU spec' },
    { wrong: '#f59e0b', canonical: '#cda852', name: '--p31-amber', source: 'Tailwind amber-500 leak' },
    { wrong: '#f87171', canonical: '#cc6247', name: '--p31-coral', source: 'Tailwind red-400 leak' },
    { wrong: '#14b8a6', canonical: '#5DCAA5', name: '--p31-teal', source: 'Tailwind teal-500 leak' },
    { wrong: '#10b981', canonical: '#5DCAA5', name: '--p31-teal', source: 'Tailwind emerald-500 leak' },
  ...
  for (const bt of BANNED_TOKENS) {
    ...
    for (const file of sourceFiles) {
      ...
      if (!content) continue;
      // Skip this test file itself, docs, and comments-only matches
