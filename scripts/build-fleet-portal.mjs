...
<head>
  ...
  <style>
    ...
    .fp-hero h1 {
      font-size: clamp(1.25rem, 3.5vw + 0.85rem, 1.75rem);
      margin: 0 0 0.35rem;
    ...
    .fp-table-wrap { overflow-x: auto; -webkit-overflow-scrolling: touch; margin: 0.5rem 0 1.75rem; }
    .fp-table { width: 100%; min-width: min(100%, 36rem); border-collapse: collapse; font-size: 0.9rem; }
...
<body class="p31-surface p31-responsive-surface" data-soup-psych="1">
  <div class="fp-page">
